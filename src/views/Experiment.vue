            ...
            <div v-if="this.$globalData.role !== 1">
                ...
                <div style="margin: 20px">
                    ...
                    <el-form-item label="实验标题" prop="title">
                        <el-input v-model="form.title" placeholder="请输入实验标题"></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="实验文档" prop="content">
                        <el-input v-model="form.content" placeholder="请输入实验所需实验文档名"></el-input>
                    </el-form-item>
                    <el-form-item label="实验简介" prop="introduction">
                        <el-input type="textarea" v-model="form.introduction" :autosize="{ minRows: 4 }" placeholder="请输入实验简介"></el-input>
                    </el-form-item>
                    <el-form-item>
...
export default {
    ...
    methods:{
        ...
        onSubmitExercise(){
            console.log('新增实验',this.form)

            // ——————————————与后台交互——————————————

            let isSuccess = true
            this.form.eid = 2021//从后台接收eid
            // ——————————————————————————————————————
            if (isSuccess) {
                //输出成功信息
                this.$message({
                ...
                this.t_exercise.unshift(this.form)
                this.form = {}
            }
            else {
