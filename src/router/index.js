  ...
  routes: [
    ...
    {path: '/index', name: '', component: ()=>import('../views/Index'),
     children: [
      ...
      {path: '/homeworkBoard', name:'HomeworkBoard', component: ()=>import('../views/homework/HomeworkBoard'),meta:['作业辅导','师生交流']},
      ...
      {path: '/map', name:'Map', component: ()=>import('../views/Map'),meta:['知识图谱']},
